...
class FsScrollable extends LitElement {
	static styles = css`
		...
		.overlay {
			--_gradient-start: color-mix(in srgb, var(--fs-scrollable--background-color, white) 0%, transparent);
			--_gradient-middle: color-mix(in srgb, var(--fs-scrollable--background-color, white) 80%, transparent);
			--_gradient-end: color-mix(in srgb, var(--fs-scrollable--background-color, white) 100%, transparent);
			align-items: center;
			background: linear-gradient(var(--_deg), var(--_gradient-start) 0%, var(--_gradient-middle) 50%, var(--_gradient-end) 100%);
			display: flex;
			height: 100%;
